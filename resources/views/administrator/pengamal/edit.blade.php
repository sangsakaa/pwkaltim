<x-app-layout>
    ...
    <div class="  p-2 overflow-hidden bg-white rounded-md shadow-md dark:bg-dark-eval-1">
        <div>
            ...
            <form action="/pengamal/update/{{ $pengamal->id }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                        <div class="mb-3">
                            ...
                            <input type="text" name="nik" id="nik" placeholder="Wajib diisi sesuai KTP / KIA" class="w-full rounded-md"
                                maxlength="16" value="{{ old('nik', $pengamal->nik) }}" required>
